...
$(document).ready(function () {
    ...
    var totalMediaCountUrl = app.Urls.totalMediaCountUrl;
    ...
    $.ajax({
        type: "GET",
        url: totalMediaCountUrl,
        dataType: "json",
        success: function (data) {
            $("h3#totalMediaCount").append(data);
        },
        error: function () {
            toastr.error("Resim Analizleri yüklenirken hata oluştu", "Hata");
        }
